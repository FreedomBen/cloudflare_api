defmodule CloudflareApi.SecondaryDnsAcl do
  @moduledoc ~S"""
  ...
  def delete(client, account_id, acl_id) do
    c(client)
    |> Tesla.delete(acl_path(account_id, acl_id), body: %{})
    |> handle_response()
  end

  defp base_path(account_id), do: "/accounts/#{account_id}/secondary_dns/acls"
  defp acl_path(account_id, acl_id), do: base_path(account_id) <> "/#{encode(acl_id)}"
