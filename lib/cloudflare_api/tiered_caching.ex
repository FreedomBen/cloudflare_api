defmodule CloudflareApi.TieredCaching do
  @moduledoc ~S"""
  ...
  @doc ~S"""
  Update tiered caching settings (`PATCH /argo/tiered_caching`).
  """
  ...
  defp path(zone_id), do: "/zones/#{zone_id}/argo/tiered_caching"
