defmodule CloudflareApi.AccountLoadBalancerMonitorGroups do
  @moduledoc ~S"""
  ...
  def list_references(client, account_id, group_id) do
    c(client)
    |> Tesla.get(group_path(account_id, group_id) <> "/references")
    |> handle_response()
  end
  ...
  defp base_path(account_id), do: "/accounts/#{account_id}/load_balancers/monitor_groups"
