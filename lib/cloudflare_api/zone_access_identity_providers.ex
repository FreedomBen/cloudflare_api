defmodule CloudflareApi.ZoneAccessIdentityProviders do
  @moduledoc ~S"""
  ...
  def delete(client, zone_id, provider_id) do
    c(client)
    |> Tesla.delete(provider_path(zone_id, provider_id), body: %{})
    |> handle_response()
  end

  defp base_path(zone_id), do: "/zones/#{zone_id}/access/identity_providers"
  defp provider_path(zone_id, provider_id), do: base_path(zone_id) <> "/#{provider_id}"
