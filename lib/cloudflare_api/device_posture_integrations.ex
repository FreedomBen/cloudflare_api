defmodule CloudflareApi.DevicePostureIntegrations do
  @moduledoc ~S"""
  ...
  defp base(account_id), do: "/accounts/#{account_id}/devices/posture/integration"
  defp integration_path(account_id, integration_id), do: base(account_id) <> "/#{integration_id}"
